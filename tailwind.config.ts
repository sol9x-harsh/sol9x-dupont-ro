  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        permeate: { DEFAULT: "hsl(var(--permeate))", soft: "hsl(var(--permeate-soft))" },
        concentrate: { DEFAULT: "hsl(var(--concentrate))", soft: "hsl(var(--concentrate-soft))" },
        feed: { DEFAULT: "hsl(var(--feed))", soft: "hsl(var(--feed-soft))" },
